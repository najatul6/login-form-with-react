...
const SignUp = () => {
    ...
    return (
        <div>
            <div className="max-w-[1440px] mx-auto py-10 min-h-screen md:mt-[10%]">
                <div className="flex justify-center items-center">
                    <div className=" flex flex-col rounded-xl bg-transparent bg-clip-border text-gray-700 shadow-none">
                        ...
                        {
                            successes && <p className='text-lg font-bold text-green-700 text-center'>User Created Successfully </p>
                        }
                        {
                            registerError && <p className='text-red-500 text-lg font-bold text-center'> {registerError} </p>
                        }
